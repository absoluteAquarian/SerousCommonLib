...
namespace SerousCommonLib.API {
	partial class FastReflection {
		...
		/// <summary>
		/// Retrieves the value of <paramref name="fieldName"/> from <paramref name="instance"/> as an <see cref="object"/>
		/// </summary>
		...
		/// <summary>
		/// Retrieves the value of <paramref name="fieldName"/> from <paramref name="instance"/> as a <typeparamref name="T"/>
		/// </summary>
		...
		/// <summary>
		/// Retrieves the value of <paramref name="fieldName"/> from <paramref name="instance"/> as a <typeparamref name="F"/>
		/// </summary>
		/// <typeparam name="T">The object type</typeparam>
		...
		/// <summary>
		/// Retrieves the value of the static field <paramref name="fieldName"/> in <paramref name="type"/> as an <see cref="object"/>
		/// </summary>
		...
		/// <summary>
		/// Retrieves the value of the static field <paramref name="fieldName"/> in <paramref name="type"/> as a <typeparamref name="T"/>
		/// </summary>
		/// <typeparam name="T">The field type</typeparam>
		/// <param name="type">The type</param>
		/// <param name="fieldName">The field name</param>
		...
		/// <summary>
		/// Assigns <paramref name="value"/> to <paramref name="fieldName"/> in <paramref name="instance"/><br/>
		/// <b>NOTE:</b> This method will throw an exception if <paramref name="type"/> is a <see langword="struct"/> type
		/// </summary>
		/// <param name="type">The object type</param>
		/// <param name="fieldName">The field name</param>
		/// <param name="instance">The object instance</param>
		...
		/// <summary>
		/// Assigns <paramref name="value"/> to <paramref name="fieldName"/> in <paramref name="instance"/>
		/// </summary>
		/// <typeparam name="T">The object type</typeparam>
		/// <param name="instance">The object instance</param>
		/// <param name="fieldName">The field name</param>
		...
		/// <summary>
		/// Assigns <paramref name="value"/> to the static field <paramref name="fieldName"/> in <paramref name="type"/>
		/// </summary>
		/// <param name="type">The type</param>
		/// <param name="fieldName">The field name</param>
		/// <param name="value">The value to assign</param>
		...
		private static FieldGenericDelegates<T>.RetrieveDelegate BuildGenericRetrieveFieldDelegate<T>(string fieldName) {
			...
			if (!FieldGenericDelegates<T>.retrieveUnloadingRegistered) {
				...
				Loadable.Unload += FieldGenericDelegates<T>.getFieldFuncs.Clear;
			}
		...
		private static FieldGenericDelegates<T>.AssignDelegate BuildGenericAssignFieldDelegate<T>(string fieldName) {
			...
			if (!FieldGenericDelegates<T>.assignUnloadingRegistered) {
				...
				Loadable.Unload += FieldGenericDelegates<T>.setFieldFuncs.Clear;
			}
